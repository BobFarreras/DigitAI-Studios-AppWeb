...
## Quan carregar
Qualsevol task que impliqui UI, estils, colors, tipografia, espaiat, components visuals o disseny.
...
## Components Reference (ShadcnUI + Custom)
...
## Checklist
1. Colors usen tokens de DESIGN.md?
2. Accent principal usa neon-lime?
3. Border radius és 6px (o 2px tags)?
4. Tipografia usa Inter Variable?
5. Superfícies segueixen l'ordre d'elevació?