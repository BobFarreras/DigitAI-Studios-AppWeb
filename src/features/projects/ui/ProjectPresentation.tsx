...
import { CompanyBuildJourney } from "./CompanyBuildJourney";
...
import { ProjectGuideNav } from "./ProjectGuideNav";
  ...
  return (
    <main data-cursor-contrast="light" className="min-h-screen overflow-hidden bg-[#08080d] pt-16 text-white">
      ...
      <section className="relative mx-auto flex min-h-[92svh] max-w-7xl flex-col justify-center px-5 pb-20 pt-28 sm:px-8">
        ...
        <a href="#construccio" className="absolute bottom-8 left-5 flex items-center gap-3 text-xs uppercase tracking-[0.18em] text-white/40 sm:left-8">Construir l’empresa<ArrowDown className="h-4 w-4 animate-bounce" /></a>
      </section>

      <section id="construccio" className="scroll-mt-40 mx-auto max-w-7xl px-5 py-24 sm:px-8"><CompanyBuildJourney /></section>

      <section id="rutes" className="scroll-mt-40 mx-auto max-w-7xl px-5 py-24 sm:px-8"><BusinessRoutes /></section>

      <section id="web-software" className="scroll-mt-40 mx-auto max-w-7xl px-5 py-24 sm:px-8"><WebAppDelivery /></section>

      <section id="automatitzacions" className="scroll-mt-40 mx-auto max-w-7xl px-5 py-24 sm:px-8"><N8nStrategy /></section>

      <section id="agents-ia" className="scroll-mt-40 mx-auto max-w-7xl px-5 py-24 sm:px-8"><p className="text-xs uppercase tracking-[0.2em] text-cyan-300">05 · Agents i canals</p><h2 className="mb-10 mt-4 max-w-4xl text-4xl tracking-[-0.05em] sm:text-6xl">WhatsApp, IA i automatització sense perdre el control.</h2><AiStrategy /></section>

      <section id="vendes" className="scroll-mt-40 mx-auto max-w-7xl px-5 py-24 sm:px-8"><SalesEngine /></section>

      <section id="salut" className="scroll-mt-40 mx-auto max-w-7xl px-5 py-24 sm:px-8"><CompanyHealth /></section>

      <section id="seguretat" className="scroll-mt-40 mx-auto max-w-7xl px-5 py-24 sm:px-8"><SecurityCompliance /></section>

      <section id="governanca" className="scroll-mt-40 mx-auto max-w-7xl px-5 py-24 sm:px-8"><p className="text-xs uppercase tracking-[0.2em] text-emerald-300">09 · Governança</p><h2 className="mb-10 mt-4 max-w-4xl text-4xl tracking-[-0.05em] sm:text-6xl">Responsabilitats separades. Costos visibles.</h2><OperatingModel /></section>

      <section id="costos" className="scroll-mt-40 mx-auto max-w-7xl px-5 py-24 sm:px-8"><CostReference /></section>
