...
const TEXT: Record<string, readonly [string, string, string, string]> = {
  ...
  'Control horari i equip SAT': ['Control horari i equip SAT', 'Control horario y equipo SAT', 'Time control and SAT team', 'Controllo orario e team SAT'],
  'Treballadors, hores, extres, SATs, permisos i planificacio.': ['Treballadors, hores, extres, SATs, permisos i planificacio.', 'Trabajadores, horas, extras, SATs, permisos y planificación.', 'Workers, hours, overtime, SAT jobs, permissions and planning.', 'Tecnici, ore, straordinari, SAT, permessi e pianificazione.'],
  'Dia': ['Dia', 'Día', 'Day', 'Giorno'],
  'Setmana': ['Setmana', 'Semana', 'Week', 'Settimana'],
  'Mes': ['Mes', 'Mes', 'Month', 'Mese'],
  'Calendari': ['Calendari', 'Calendario', 'Calendar', 'Calendario'],
  'Afegir': ['Afegir', 'Añadir', 'Add', 'Aggiungi'],
  'Treballador': ['Treballador', 'Trabajador', 'Worker', 'Tecnico'],
  'Hores': ['Hores', 'Horas', 'Hours', 'Ore'],
  'Extres': ['Extres', 'Extras', 'Overtime', 'Straordinari'],
  'Mitjana SAT': ['Mitjana SAT', 'Media SAT', 'SAT average', 'Media SAT'],
  'Permis': ['Permís', 'Permiso', 'Permission', 'Permesso'],
  'fetes': ['fetes', 'hechas', 'done', 'completati'],
  'obertes': ['obertes', 'abiertas', 'open', 'aperti'],
  'Equip': ['Equip', 'Equipo', 'Team', 'Team'],
  'Zona': ['Zona', 'Zona', 'Zone', 'Zona'],
  'Hores generals': ['Hores generals', 'Horas generales', 'General hours', 'Ore totali'],
  'Hores extres': ['Hores extres', 'Horas extra', 'Overtime hours', 'Ore straordinarie'],
  'SATs completats': ['SATs completats', 'SATs completados', 'Completed SAT jobs', 'SAT completati'],
  'SATs i hores imputades': ['SATs i hores imputades', 'SATs y horas imputadas', 'SAT jobs and logged hours', 'SAT e ore registrate'],
  'Clica qualsevol SAT per obrir la fitxa operativa concreta.': ['Clica qualsevol SAT per obrir la fitxa operativa concreta.', 'Haz clic en cualquier SAT para abrir la ficha operativa concreta.', 'Click any SAT job to open its operational record.', 'Clicca su qualsiasi SAT per aprire la scheda operativa.'],
  'Material imputat': ['Material imputat', 'Material imputado', 'Logged material', 'Materiale registrato'],
  'Control horari': ['Control horari', 'Control horario', 'Time control', 'Controllo orario'],
  'Calendari operatiu 07:00-18:00': ['Calendari operatiu 07:00-18:00', 'Calendario operativo 07:00-18:00', 'Operational calendar 07:00-18:00', 'Calendario operativo 07:00-18:00'],
  'Dl': ['Dl', 'Lu', 'Mon', 'Lun'],
  'Dt': ['Dt', 'Ma', 'Tue', 'Mar'],
  'Dc': ['Dc', 'Mi', 'Wed', 'Mer'],
  'Dj': ['Dj', 'Ju', 'Thu', 'Gio'],
  'Dv': ['Dv', 'Vi', 'Fri', 'Ven'],
  'Alta de treballador': ['Alta de treballador', 'Alta de trabajador', 'Create worker', 'Nuovo tecnico'],
  'Crea la fitxa base, permisos i condicions de jornada.': ['Crea la fitxa base, permisos i condicions de jornada.', 'Crea la ficha base, permisos y condiciones de jornada.', 'Create the base profile, permissions and working schedule.', 'Crea profilo base, permessi e condizioni orarie.'],
  'Nom complet': ['Nom complet', 'Nombre completo', 'Full name', 'Nome completo'],
  'Rol': ['Rol', 'Rol', 'Role', 'Ruolo'],
  'Contracte': ['Contracte', 'Contrato', 'Contract', 'Contratto'],
  'PIN / QR': ['PIN / QR', 'PIN / QR', 'PIN / QR', 'PIN / QR'],
  'Laborable + guardies': ['Laborable + guardies', 'Laborable + guardias', 'Business days + on-call', 'Feriali + reperibilità'],
  'Crear fitxa': ['Crear fitxa', 'Crear ficha', 'Create profile', 'Crea scheda'],
  'Tècnic': ['Tècnic', 'Técnico', 'Technician', 'Tecnico'],
  'Coordinador': ['Coordinador', 'Coordinador', 'Coordinator', 'Coordinatore'],
  'Admin': ['Admin', 'Admin', 'Admin', 'Admin'],
  'Planificacio pendent': ['Planificacio pendent', 'Planificación pendiente', 'Pending planning', 'Pianificazione in attesa'],
  'Ruta': ['Ruta', 'Ruta', 'Route', 'Giro'],
  'Obertura magatzem': ['Obertura magatzem', 'Apertura almacén', 'Warehouse opening', 'Apertura magazzino'],
  'Marta · preparacio ruta': ['Marta · preparacio ruta', 'Marta · preparación ruta', 'Marta · route prep', 'Marta · preparazione giro'],
  'Finques Tramuntana · revisio': ['Finques Tramuntana · revisio', 'Finques Tramuntana · revisión', 'Finques Tramuntana · inspection', 'Finques Tramuntana · revisione'],
  'CRM proposta': ['CRM proposta', 'CRM propuesta', 'CRM proposal', 'CRM proposta'],
  'Hotel Costa Brava · calderes': ['Hotel Costa Brava · calderes', 'Hotel Costa Brava · calderas', 'Hotel Costa Brava · boilers', 'Hotel Costa Brava · caldaie'],
  'Gimnas Activa · bomba pressio': ['Gimnas Activa · bomba pressio', 'Gimnasio Activa · bomba presión', 'Activa Gym · pressure pump', 'Palestra Activa · pompa pressione'],
  'Restaurant Sa Riera · embus': ['Restaurant Sa Riera · embus', 'Restaurante Sa Riera · atasco', 'Sa Riera Restaurant · blockage', 'Ristorante Sa Riera · intasamento'],
  'Reposicio material': ['Reposicio material', 'Reposición material', 'Material restock', 'Riordino materiale'],
  'Valvules i sondes NTC': ['Valvules i sondes NTC', 'Válvulas y sondas NTC', 'Valves and NTC sensors', 'Valvole e sonde NTC'],
  'Vacances': ['Vacances', 'Vacaciones', 'Vacation', 'Ferie'],
  'Nil Ruiz · tarda aprovada': ['Nil Ruiz · tarda aprovada', 'Nil Ruiz · tarde aprobada', 'Nil Ruiz · afternoon approved', 'Nil Ruiz · pomeriggio approvato'],
  'Guardia activa': ['Guardia activa', 'Guardia activa', 'Active on-call', 'Reperibilità attiva'],
  'Julia · urgencies 24/7': ['Julia · urgencies 24/7', 'Julia · urgencias 24/7', 'Julia · 24/7 emergencies', 'Julia · urgenze 24/7'],
  'Comunitat Mar Blava · fuita': ['Comunitat Mar Blava · fuita', 'Comunidad Mar Blava · fuga', 'Mar Blava Community · leak', 'Comunità Mar Blava · perdita'],
  'Tancament jornada': ['Tancament jornada', 'Cierre jornada', 'End of shift', 'Chiusura giornata'],
  'Fotos i materials imputats': ['Fotos i materials imputats', 'Fotos y materiales imputados', 'Photos and logged materials', 'Foto e materiali registrati'],
  'Reunio client': ['Reunio client', 'Reunión cliente', 'Client meeting', 'Riunione cliente'],
  'Campus EduNova · manteniment': ['Campus EduNova · manteniment', 'Campus EduNova · mantenimiento', 'EduNova Campus · maintenance', 'Campus EduNova · manutenzione'],
  'Hotel Costa Brava · bloquejat': ['Hotel Costa Brava · bloquejat', 'Hotel Costa Brava · bloqueado', 'Hotel Costa Brava · blocked', 'Hotel Costa Brava · bloccato'],
  'Apartaments Nord · tancament': ['Apartaments Nord · tancament', 'Apartamentos Nord · cierre', 'Nord Apartments · closeout', 'Appartamenti Nord · chiusura'],
  'Seguiment CRM': ['Seguiment CRM', 'Seguimiento CRM', 'CRM follow-up', 'Follow-up CRM'],
  'Planificacio setmana': ['Planificacio setmana', 'Planificación semana', 'Weekly planning', 'Pianificazione settimana'],
  'Coordinacio equip SAT': ['Coordinacio equip SAT', 'Coordinación equipo SAT', 'SAT team coordination', 'Coordinamento team SAT'],
};
