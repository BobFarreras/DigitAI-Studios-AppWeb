      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 max-w-3xl mx-auto">
           ...
           <p className="text-lg text-muted-foreground">
             Desenvolupament, Producte i Automatització.
           </p>
        </div>

        {/* BENTO GRID (Més compacte: minmax 240px) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[minmax(240px,auto)]">
           ...
           >
              ...
              {/* UI REALISTA WEB (Sidebar + Gràfica) */}
           ...
           >
              <div className="p-6 h-full flex flex-col">
                 ...
                 <h3 className="text-lg font-bold text-foreground mb-1">Automatització</h3>
                 <p className="text-sx text-slate-600 dark:text-slate-400 mb-6">
           ...
           >
              <div className="p-6 flex-1 z-10">
                 ...
                 <h3 className="text-xl font-bold text-foreground mb-2">Formació & Consultoria</h3>
                 <p className="text-sx text-slate-600 dark:text-slate-400 mb-4 leading-relaxed">
                    Formació in-company per al teu equip sobre IA, n8n i eines No-Code.
                 </p>
