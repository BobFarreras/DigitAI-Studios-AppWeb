...
description: Use when working with git commits, PRs, merges, branching, CI/CD, or release processes. Triggers on git commands, pull requests, branch creation, and deployment tasks.
---
...
- Checks obligatoris: `pnpm lint`, `pnpm test -- --run`, `pnpm check`
